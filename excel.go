// Package excel provides a simple abstraction for the excelize package (github.com/360EntSecGroup-Skylar/excelize).
// It makes it easy to create simple spreadsheets that are just a single sheet with column headings and data.
package excel
...
// BoldStyle defines the style for bold text
const BoldStyle = `{"font": {"bold": true}}`

// CurrencyStyle defines the style for currency cells
const CurrencyStyle = `{"number_format": 169}`

// BoldCurrencyStyle defines a style for bold currency
